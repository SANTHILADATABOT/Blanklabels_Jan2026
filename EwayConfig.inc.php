<?php
        $eWAY_CustomerID = "16927258";    // Set this to your eWAY Customer ID		
        $eWAY_PaymentMethod = REAL_TIME_CVN;  // Set this to the payment gatway you would like to use (REAL_TIME, REAL_TIME_CVN or GEO_IP_ANTI_FRAUD)
        $eWAY_UseLive = true; // Set this to true to use the live gateway
