...
<li><span><?php echo BOX_HEADING_EZPAGES; ?></span>
      <ul>
        <li><a href="index.php?main_page=page&id=3">About Us</a></li>
...
<?php } ?>
    ...
    <li id="inc-gst"><img alt="Prices now include GST!" title="Prices now include GST!" src="images/prices-now-include-gst.gif" style="width:100%;max-width:200px;"></li>
