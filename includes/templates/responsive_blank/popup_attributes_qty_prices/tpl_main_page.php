...
//                $attribute_quantity .= '<td class="alignCenter">' . (($i <= 1 and $attribute_table_cost[$i] != 1) ? '1-' . $attribute_table_cost[$i] : $attribute_table_cost[$i-2]+1 . '-' . $attribute_table_cost[$i]) . '</td>';
                ...
                $attribute_quantity_price .= '<td class="alignCenter">' . $currencies->display_price($attribute_table_cost[$i+1], zen_get_tax_rate($_GET['products_tax_class_id'])) . '</td>';
...
//                $attribute_quantity_price .= '<td class="alignCenter">' . $attribute_table_cost[$i+1] . '</td>';
