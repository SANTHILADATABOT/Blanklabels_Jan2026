  ...
  $content .= '<div id="cartBoxListWrapper">' . "\n" . '<ul>' . "\n";
    ...
    for ($i=0, $n=sizeof($products); $i<$n; $i++) {
      ...
      if (isset($_SESSION['new_products_id_in_cart']) && ($_SESSION['new_products_id_in_cart'] == $products[$i]['id'])) {
        ...
        $content .= '<span class="cartOldItem"><b>';

      }



      $content .= $products[$i]['quantity'] . BOX_SHOPPING_CART_DIVIDER . '</b></span>&nbsp;&nbsp;&nbsp;&nbsp;<a href="' . zen_href_link(zen_get_info_page($products[$i]['id']), 'products_id=' . $products[$i]['id']) . '">';
