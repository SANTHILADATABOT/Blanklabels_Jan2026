...
define('FOOTER_TEXT_BODY', 'Copyright &copy; 2022 BlankLabels.com.au<br>');
define('FOOTER_TEXT', 'Copyright &copy; 2022 BlankLabels.com.au');
...
// Define the name of your Gift Certificate as Gift Voucher, Gift Certificate, Zen Cart Dollars, etc. here for use through out the shop
  define('TEXT_GV_NAME','Discount Voucher');
...
// categories box text in sideboxes/categories.php
  define('BOX_HEADING_CATEGORIES', 'Find your labels');
...
// information box text in sideboxes/more_information.php - were TUTORIAL_
  ...
  define('BOX_INFORMATION_PAGE_2', 'Help &amp; Frequently Asked Questions');
  define('BOX_INFORMATION_PAGE_3', 'Label Stock &amp; Printer Guide');
  define('BOX_INFORMATION_PAGE_4', 'Submitting Artwork');
  define('BOX_INFORMATION_PAGE_5', 'Postage &amp; Despatch');
  define('BOX_INFORMATION_PRINTLABELS', 'How to print your own labels');
  define('BOX_INFORMATION_LABELTEMPLATES', 'Label Templates');
...
// javascript messages
  ...
  define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS', 'Displaying <strong>%d</strong> to <strong>%d</strong> (of <strong>%d</strong> results)');
  ...
  define('TEXT_UNKNOWN_TAX_RATE', 'GST');
...
// cart contents
  ...
  define('PRODUCTS_ORDER_QTY_TEXT',' How many?');
...
// banner_box
  define('BOX_HEADING_BANNER_BOX','Label Templates!');
  define('TEXT_BANNER_BOX','Please Visit Our Sponsors ...');

// banner box 2
  define('BOX_HEADING_BANNER_BOX2','Secure Payments');
  define('TEXT_BANNER_BOX2','Checkout with confidence!');

// banner_box - all
  define('BOX_HEADING_BANNER_BOX_ALL','WOW! Look at this!');
  define('TEXT_BANNER_BOX_ALL','Free postage! ...');
...
// discount qty table
  define('TEXT_HEADER_DISCOUNT_PRICES_PERCENTAGE', '<strong>Quantity Discounts - automatically calculated<br/>10-20 boxes - 5%; 20-30 boxes - 7.5%; 30+ boxes 10%</strong>');
  define('TEXT_HEADER_DISCOUNT_PRICES_ACTUAL_PRICE', 'Qty Discounts New Price');
  define('TEXT_HEADER_DISCOUNT_PRICES_AMOUNT_OFF', 'Quantity Discounts Off Price');
  define('TEXT_FOOTER_DISCOUNT_QUANTITIES', 'See example below');
...
// added missing button names
  define('BUTTON_LOOKUP_ALT', 'Look-up');
