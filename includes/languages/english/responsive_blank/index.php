...
if (STORE_STATUS == '0') {
  ...
  define('TEXT_GREETING_GUEST', 'Welcome to BlankLabels.com.au. Be Creative with the largest range of self-adhesive labels in the world!');
}
...
if ( ($category_depth == 'products') || (zen_check_url_get_terms()) ) {
  ...
  define('HEADING_TITLE',  'BlankLabels, the largest range of self-adhesive labels and stickers');
