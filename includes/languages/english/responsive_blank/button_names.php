 ...
 */
define('BUTTON_ADD_TO_CART_ALT', 'Add These Blank Labels to My Cart');
...
define('BUTTON_CONFIRM_SEND_ALT', 'Send Blank Labels Gift Certificate');
define('BUTTON_CONFIRM_ORDER_ALT', 'Confirm Blank Labels Order');
define('BUTTON_CONTINUE_ALT', 'Continue');
define('BUTTON_CONTINUE_SHOPPING_ALT', 'Continue Shopping for Blank Labels');
...
define('BUTTON_LOGIN_ALT', 'Sign In to Blank Labels.com.au');
define('BUTTON_LOG_OFF_ALT', 'Log Out');
define('BUTTON_NEXT_ALT', 'Next Blank Labels product');
define('BUTTON_PREVIOUS_ALT', 'Previous Blank Labels product');
define('BUTTON_REDEEM_ALT', 'Redeem');
define('BUTTON_RETURN_TO_PROD_LIST_ALT', 'Return to Blank Labels Product List');
define('BUTTON_REVIEWS_ALT', 'Go to the Blank Labels Reviews Page');
define('BUTTON_SEARCH_ALT', 'Search for Blank Labels');
define('BUTTON_SEND_ALT', 'Send Now');
define('BUTTON_SEND_ANOTHER_ALT', 'Send Another Blank Labels.com.au Gift Certificate');
define('BUTTON_SEND_A_GIFT_CERT_ALT', 'Send A Blank Labels Gift Certificate');
define('BUTTON_SHIPPING_ESTIMATOR_ALT', ' Blank Labels Shipping Estimator');
define('BUTTON_SOLD_OUT_ALT', 'Sold Out of Blank Labels');
define('BUTTON_SOLD_OUT_SMALL_ALT', 'Sold Out of Blank Labels');
define('BUTTON_SUBMIT_ALT', 'Submit the Information to Blank Labels.com.au');
define('BUTTON_TELL_A_FRIEND_ALT', 'Tell a Friend about Blank Labels');
define('BUTTON_TELLAFRIEND_ALT', 'Tell a Friend about Blank Labels');
define('BUTTON_UNSUBSCRIBE', 'Unsubscribe from  Blank Labels.com.au');
define('BUTTON_UPDATE_ALT', 'Update');
define('BUTTON_VIEW_SMALL_ALT', 'View');
define('BUTTON_WRITE_REVIEW_ALT', 'Write Review about Blank Labels.com.au');
define('BUTTON_READ_REVIEWS_ALT', 'Read the Review of Blank Labels.com.au');
define('BUTTON_GOTO_PROD_DETAILS_ALT', 'Go To This Blank Labels product/s Detailed Information');
define('BUTTON_MORE_REVIEWS_ALT', 'Read More Reviews about Blank Labels');
?>