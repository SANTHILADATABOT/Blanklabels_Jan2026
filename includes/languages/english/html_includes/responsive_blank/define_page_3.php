...
<div class="stoguide">
  <table class="cattab" width="100%">
    ...
    <tr>
      <td colspan="4"><b>Stock:</b> Matt &amp; Gloss<div class="imgright"><img alt="Heat Resistant" src="images/stocks/heat.gif" title="Heat Resistant"><img alt="Acid, Oil and Solvent Resistant" src="images/stocks/acid.gif" title="Acid, Oil and Solvent Resistant"><img alt="Outdoor Use" src="images/stocks/outdoor.gif" title="Outdoor Use"><img alt="Strong Adhesion" src="images/stocks/strong.gif" title="Strong Adhesion"><img alt="Moisture Resistant" src="images/stocks/moisture.gif" title="Moisture Resistant"><img alt="Can go in Freezer" src="images/stocks/freezer.gif" title="Can go in Freezer"></div></td>
      </tr>
    <tr class="bord">
...
<p>Its also worth noting that inkjet ink is water based and will run if it gets wet - although there is a synthetic label on which you can print with and inkjet printer, and it won't run! Check  out the <strong>Dataflex 303 PE White</strong>.</p>
...
<table class="tred alt">
  ...
  <tr>
    ...
    <td><strong>Laser & photocopier only.</strong><br />Has a stronger adhesive than standard paper labels, so it is well suited to where you want that bit more 'stickability'</td>
  </tr>
  <tr>
    ...
    <td><strong>Laser & photocopier only.</strong><br />Matt FR8 can be printed with an inkjet, but if the label gets wet the ink will run.</td>
  </tr>
  <tr>
    ...
    <td><strong>Laser & photocopier only.</strong><br />Matt WLK 202 can be printed with an inkjet, but if the label gets wet the ink will run. This is significant especially for white wines which are often cooled in an ice bucket. </td>
  </tr>
</table>
...
<table class="tred alt">
  ...
  <tr>
    <td><strong>Datapol PET white & Translucent.</strong><br />Datapol is ideal for outside or rugged conditions use. Weatherproof and often used for labels to stick on cars, etc.</td>
    <td>Laser & photocopier only</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><strong>Dataflex 303 PE White.</strong><br />This is the only synthetic label you can use with an inkjet printer - and it's weatherproof too! The ink doesn't run, because the softer porous surface of the label absorbs the ink. </td>
    <td>Inkjet OK. Also suitable for offset printing. Not suitable for laser.</td>
  </tr>
  <tr>
    <td><strong>Polyester white.</strong><br />A fine weather resistant label.</td>
    <td>Suitable for offset and screen printing. </td>
  </tr>
</table>
