 ...
 */
  ...
  define ('EMAIL_LOGO_ALT_TITLE_TEXT', 'BlankLabels.com.au');
...
// email disclaimer
  ...
  define('EMAIL_SPAM_DISCLAIMER','This email is sent in accordance with Australian anti-spam legislation. Removal requests can be sent to this address and will be honored and respected.');
  define('EMAIL_FOOTER_COPYRIGHT','Copyright (c) ' . date('Y') . ' <a href="https://www.blanklabels.com.au" target="_blank">BlankLabels.com.au</a><br/>ABN: 49 154 866 396<br/>PO Box 2037<br/>Bayswater VIC 3153<br/>Ph: (03) 5611 0491<br/>9am-5pm Mon-Fri<br/>');
