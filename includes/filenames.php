...
define('FILENAME_PRINTLABELS', 'printlabels');

define('FILENAME_LABELTEMPLATES', 'labeltemplates');

define('FILENAME_DEFINE_PRINTLABELS', 'define_printlabels');

define('FILENAME_DEFINE_LABELTEMPLATES', 'define_labeltemplates');
