...
echo "<br/>URL: " . $this->myGatewayURL;
echo "<br/><br/><b>XML Request</b>:<br/>". $xmlRequest;
        $ch = curl_init($this->myGatewayURL); 
        //$ch = curl_init("www.eway.com.au"); 
	 curl_setopt($ch, CURLOPT_HTTPHEADER, array('Content-Type: application/x-www-form-urlencoded'));
        ...
        $xmlResponse = curl_exec($ch);
            ...
            if(curl_errno($ch))
            {
                echo "<br/><b>Curl Error</b>: " . curl_error($ch);
                echo "<br/><b>Curl Error No</b>: " . curl_errno($ch);
            }
            echo "<br/><br/><b>XML Response Starts</b>:<br/>" . $xmlResponse;
            echo "<br/><b>XML Response End</b><br/><br/>";
