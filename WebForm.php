...
<span id="Label1">CustomerID:</span></TD>
    <TD bgColor=gainsboro>
    <strong><?php echo "$eWAY_CustomerID"; ?></strong></TD></TR>
  <TR>
    <TD bgColor=gainsboro>
...
<span id="Label2">Card Number:</span></TD>
    <TD bgColor=red>
<input name="txtCCNumber" type="text" maxlength="17" autocomplete="off" id="txtCCNumber" /></TD></TR>
<TR><TD bgColor=red>
<span id="Label2">CVN:</span></TD>
    <TD bgColor=red>
<input name="txtCVN" type="text" maxlength="4" size="8" autocomplete="off" id="txtCVN" /></TD></TR>
  <TR>
    <TD bgColor=red>
