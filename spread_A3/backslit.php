...
if (isset($_POST['confirm_update'])) {
    ...
    //     '<p>Diecut A3 self-adhesive labels.</p>

    //     <div class="selector">
    //         <h3>Select A3 diecut label size</h3>
    //         <select size="9" id="da3select" onchange="a3DieNo()">
    //             <option value="" disabled>A3 Diecut Labels</option>
    //             ' . $optionsHtml . '
    //         </select>
    //     </div>',
...
$finalHtml = htmlspecialchars(
'
<p>Diecut A3 self-adhesive labels. Available in various Paper Stocks including Matt White, Gloss White, WLK Wine Stock, Opaque Blockout and Fluorescent Colours.</p>

<p><b>All prices on this website are in Australian Dollars.</b></p>
<p><b class="red">Prices exclude GST and delivery.</b></p>

<div class="selector">
    <h3 id="select">Select A3 diecut label size</h3>
